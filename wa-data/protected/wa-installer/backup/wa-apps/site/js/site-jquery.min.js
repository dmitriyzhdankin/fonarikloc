...
(b.find(".dialog-content-indent").html(a.content),a.title&&b.find(".dialog-content-indent").prepend("<h1>"+a.title+"</h1>")),a.buttons&&b.find(".dialog-buttons-gradient").empty().append(a.buttons);else{var f=$(this),b=$("<div "+(c?'id = "'+c+'"':"")+' class="dialog '+d+'" style="display: none"><div class="dialog-background"></div><div class="dialog-window"></div></div>').appendTo("body");f.find(".dialog-content").length||f.find(".dialog-buttons").length?($(".dialog-window",b).append(f.show()),c=f.find(".dialog-content"),
c.length&&(d=$('<div class="dialog-content-indent"></div>'),c.contents().appendTo(d),c.append(d)),c=f.find(".dialog-buttons"),c.length&&(d=$('<div class="dialog-buttons-gradient"></div>'),c.contents().appendTo(d),c.append(d))):($(".dialog-window",b).append((a.onSubmit?'<form method="post" action="">':"")+'<div class="dialog-content"><div class="dialog-content-indent"></div></div><div class="dialog-buttons"><div class="dialog-buttons-gradient"></div></div>'+(a.onSubmit?"</form>":"")),b.find(".dialog-content-indent").append(f.show()));
a.buttons&&b.find(".dialog-buttons-gradient").empty().append(a.buttons);a.url?b.find(".dialog-content-indent").append("<h1>"+(a.loading_header||"")+'<i class="icon16 loading"></i></h1>'):a.content&&b.find(".dialog-content-indent").append(a.content);a.title&&b.find(".dialog-content-indent").prepend("<h1>"+a.title+"</h1>")}b.find(".dialog-background").length||b.prepend('<div class="dialog-background"> </div>');b.bind("close",function(){a.onClose&&a.onClose.call($(this));$(this).hide()});f=["width",
"height","min-width","min-height"];for(c=0;c<f.length;c++)a[f[c]]&&(("height"==f[c]&&"300px">a[f[c]]||"width"==f[c]&&"400px">a[f[c]])&&b.find("div.dialog-window").css("min-"+f[c],a[f[c]]),b.find("div.dialog-window").css(f[c],a[f[c]]));a.disableButtonsOnSubmit&&b.find("input[type=submit]").removeAttr("disabled");b.parent().length||b.appendTo("body");b.show();a.url?jQuery.get(a.url,function(c){var f=$(c);f.find(".dialog-content").length||f.find(".dialog-buttons").length?(f.find(".dialog-content").length&&
b.find(".dialog-content-indent").empty().append(f.find(".dialog-content").contents()),f.find(".dialog-buttons").length&&b.find(".dialog-buttons-gradient").empty().append(f.find(".dialog-buttons").contents())):b.find(".dialog-content-indent").html(c);b.trigger("wa-resize");a.onLoad&&a.onLoad.call(b.get(0))}):a.onLoad&&a.onLoad.call(b.get(0));b.find(".dialog-buttons").delegate(".cancel","click",function(c){c.stopPropagation();c.preventDefault();a.onCancel&&a.onCancel.call(b.get(0));b.trigger("close");
return!1});a.onSubmit&&b.find("form").unbind("submit").submit(function(){a.disableButtonsOnSubmit&&b.find("input[type=submit]").attr("disabled","disabled");return a.onSubmit.apply(this,[b])});b.bind("wa-resize",function(){var a=jQuery(this).find(".dialog-window"),b=a.width(),c=a.height();jQuery("body").css("min-height",c+"px");var f=jQuery(window).width(),d=jQuery(window).height()-60,b=(f-b)/2/f,c=(d-c-60)/2/d;0>c&&(c=0);0>b&&(b=0);a.css({left:Math.round(100*b)+"%",top:Math.round(100*c)+"%"})}).trigger("wa-resize");
...
$.wa=$.extend(!0,$.wa,{data:{},get:function(a,b){return void 0==a?this.data:this.data[name]||b||null},set:function(a){if(void 0==a)return this.data;"object"==typeof a?$.extend(this.data,a):this.data[a]=value;return this.data},encodeHTML:function(a){return a&&(""+a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},decodeHTML:function(a){return a.replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">")},setHash:function(a){!(a instanceof String)&&a.toString&&(a=a.toString());
a=a.replace(/\/\//g,"/");a=a.replace(/^.*#/,"");parent&&!$.browser.msie?parent.window.location.hash=a:location.hash=a;return!0},back:function(a){2<history.length?"number"==typeof a&&parseInt(a)==a?history.go(-a):history.go(-1):$.browser.msie&&0<history.length?history.back():a&&this.setHash(a);return!1},toggleHashParam:function(a){-1==location.hash.search(a)?this.addToHash(a):this.removeFromHash(a)},addToHash:function(a){var b=location.hash;-1==b.search(a)&&(b+="/"+a+"/");this.setHash(b)},removeFromHash:function(a){var b=
location.hash;-1<b.search(a)&&(b=b.replace(a,""));this.setHash(b)},setTitle:function(a){document.title=a},array_search:function(a,b,c){c=!!c;for(var d in b)if(c&&b[d]===a||!c&&b[d]==a)return d;return!1},dialogCreate:function(a,b){b=$.extend({content:'<h1>Loading... <i class="icon16 loading"></i></h1>',buttons:null,url:null,post:null,small:!1,onload:null,oncancel:null},b);b.content=$(b.content);b.buttons=b.buttons?$(b.buttons):$('<input type="submit" class="button gray" value="'+$_("Cancel")+'">').click(function(){b.oncancel&&
b.oncancel.call(c[0]);$.wa.dialogHide()});var c=$("#"+a);0>=c.size()&&(c=$('<div class="dialog" id="'+a+'" style="display: none"><div class="dialog-background"></div><div class="dialog-window"><div class="dialog-content"><div class="dialog-content-indent"></div></div><div class="dialog-buttons"><div class="dialog-buttons-gradient"></div></div></div></div>').appendTo("body"));c.find(".dialog-buttons-gradient").empty().append(b.buttons);c.find(".dialog-content-indent").empty().append(b.content);c.show();
b.small?c.addClass("small"):c.removeClass("small");if(b.url){var d=function(a){c.find(".dialog-content-indent").html(a);$.wa.waCenterDialog(c);b.onload&&b.onload.call(c[0])};b.post?$.post(b.url,b.post,d):$.get(b.url,d)}this.waCenterDialog(c);var f=function(a){if(c.is(":visible"))if(a&&27==a.keyCode)b.oncancel&&"function"==typeof b.oncancel&&b.oncancel.call(c[0]),$.wa.dialogHide();else $(document).one("keyup",f)};f();$(document).one("hashchange",$.wa.dialogHide);return c},waCenterDialog:function(a){a=
$(a);a=a.find(".dialog-window");var b=a.outerWidth(!0),c=a.outerHeight(!0),d=$(window).width(),f=$(window).height(),c=(f-c)/2/f;a.css({left:Math.round(100*((d-b)/2/d))+"%",top:Math.round(100*c)+"%"})},dialogHide:function(){$(".dialog").hide();return!1},dropdownsClose:function(){var a=$(".dropdown:not(.disabled)");a.addClass("disabled");setTimeout(function(){a.removeClass("disabled")},600)},dropdownsCloseEnable:function(){$(".dropdown:not(.disabled)").live("click",this.dropdownsClickHandler)},dropdownsCloseDisable:function(){$(".dropdown:not(.disabled)").die("click",
this.dropdownsClickHandler)},dropdownsClickHandler:function(){var a=$(this);a.hasClass("no-click-close")||(a.addClass("disabled"),setTimeout(function(){a.removeClass("disabled")},600))},defaultInputValue:function(a,b,c){a instanceof jQuery||(a=$(a));var d=function(){var f=a.val();if(!f||f==b)a.val(b),a.addClass(c)};d();a.blur(d);a.focus(function(){a.hasClass(c)&&(a.removeClass(c),a.val(""))})},util:{formatFileSize:function(a){var b=-1;do a/=1024,b++;while(99<a);return Math.max(a,0.01).toFixed(2)+
(0<=b?" "+$_("kB MB GB TB PB EB".split(" ")[b]):"")}}});
...
return b});if(!d)return b;a.value=d.call("DOMParser"in window&&new DOMParser||window,a.value,"text/xml");return this.isXML(a.value)?a.value:b}}}})(jQuery);(function(a){a.ui=a.ui||{};var b=/left|center|right/,c=/top|center|bottom/,d={},f=a.fn.position,e=a.fn.offset;a.fn.position=function(e){if(!e||!e.of)return f.apply(this,arguments);e=a.extend({},e);var g=a(e.of),j=g[0],l=(e.collision||"flip").split(" "),p=e.offset?e.offset.split(" "):[0,0],h,k,m;return 9===j.nodeType?(h=g.width(),k=g.height(),m={top:0,left:0}):j.setTimeout?(h=g.width(),k=g.height(),m={top:g.scrollTop(),left:g.scrollLeft()}):j.preventDefault?(e.at="left top",h=k=0,m={top:e.of.pageY,
left:e.of.pageX}):(h=g.outerWidth(),k=g.outerHeight(),m=g.offset()),a.each(["my","at"],function(){var a=(e[this]||"").split(" ");1===a.length&&(a=b.test(a[0])?a.concat(["center"]):c.test(a[0])?["center"].concat(a):["center","center"]);a[0]=b.test(a[0])?a[0]:"center";a[1]=c.test(a[1])?a[1]:"center";e[this]=a}),1===l.length&&(l[1]=l[0]),p[0]=parseInt(p[0],10)||0,1===p.length&&(p[1]=p[0]),p[1]=parseInt(p[1],10)||0,"right"===e.at[0]?m.left+=h:"center"===e.at[0]&&(m.left+=h/2),"bottom"===e.at[1]?m.top+=
k:"center"===e.at[1]&&(m.top+=k/2),m.left+=p[0],m.top+=p[1],this.each(function(){var b=a(this),f=b.outerWidth(),c=b.outerHeight(),g=parseInt(a.curCSS(this,"marginLeft",!0))||0,j=parseInt(a.curCSS(this,"marginTop",!0))||0,r=f+g+(parseInt(a.curCSS(this,"marginRight",!0))||0),s=c+j+(parseInt(a.curCSS(this,"marginBottom",!0))||0),n=a.extend({},m),u;"right"===e.my[0]?n.left-=f:"center"===e.my[0]&&(n.left-=f/2);"bottom"===e.my[1]?n.top-=c:"center"===e.my[1]&&(n.top-=c/2);d.fractions||(n.left=Math.round(n.left),
n.top=Math.round(n.top));u={left:n.left-g,top:n.top-j};a.each(["left","top"],function(b,d){a.ui.position[l[b]]&&a.ui.position[l[b]][d](n,{targetWidth:h,targetHeight:k,elemWidth:f,elemHeight:c,collisionPosition:u,collisionWidth:r,collisionHeight:s,offset:p,my:e.my,at:e.at})});a.fn.bgiframe&&b.bgiframe();b.offset(a.extend(n,{using:e.using}))})};a.ui.position={fit:{left:function(b,f){var e=a(window),e=f.collisionPosition.left+f.collisionWidth-e.width()-e.scrollLeft();b.left=0<e?b.left-e:Math.max(b.left-
...
!0),10)||0,g=parseInt(a.curCSS(b,"left",!0),10)||0,d={top:f.top-d.top+c,left:f.left-d.left+g};"using"in f?f.using.call(b,d):e.css(d)},a.fn.offset=function(b){var f=this[0];return!f||!f.ownerDocument?null:b?a.isFunction(b)?this.each(function(f){a(this).offset(b.call(this,f,a(this).offset()))}):this.each(function(){a.offset.setOffset(this,b)}):e.call(this)});a.curCSS||(a.curCSS=a.css);var g=document.getElementsByTagName("body")[0],j=document.createElement("div"),h,l;h=document.createElement(g?"div":
"body");l={visibility:"hidden",width:0,height:0,border:0,margin:0,background:"none"};g&&a.extend(l,{position:"absolute",left:"-1000px",top:"-1000px"});for(var k in l)h.style[k]=l[k];h.appendChild(j);l=g||document.documentElement;l.insertBefore(h,l.firstChild);j.style.cssText="position: absolute; left: 10.7432222px; top: 10.432325px; height: 30px; width: 201px;";j=a(j).offset(function(a,b){return b}).offset();h.innerHTML="";l.removeChild(h);g=j.top+j.left+(g?2E3:0);d.fractions=21<g&&22>g})(jQuery);(function(a,b){var c={buttons:!0,height:!0,maxHeight:!0,maxWidth:!0,minHeight:!0,minWidth:!0,width:!0},d={maxHeight:!0,maxWidth:!0,minHeight:!0,minWidth:!0};a.widget("ui.dialog",{options:{autoOpen:!0,buttons:{},closeOnEscape:!0,closeText:"close",dialogClass:"",draggable:!0,hide:null,height:"auto",maxHeight:!1,maxWidth:!1,minHeight:150,minWidth:150,modal:!1,position:{my:"center",at:"center",collision:"fit",using:function(b){var e=a(this).css(b).offset().top;0>e&&a(this).css("top",b.top-e)}},resizable:!0,
show:null,stack:!0,title:"",width:300,zIndex:1E3},_create:function(){this.originalTitle=this.element.attr("title");"string"!==typeof this.originalTitle&&(this.originalTitle="");this.options.title=this.options.title||this.originalTitle;var b=this,e=b.options,d=e.title||"&#160;",c=a.ui.dialog.getTitleId(b.element),h=(b.uiDialog=a("<div></div>")).appendTo(document.body).hide().addClass("ui-dialog ui-widget ui-widget-content ui-corner-all "+e.dialogClass).css({zIndex:e.zIndex}).attr("tabIndex",-1).css("outline",
0).keydown(function(d){e.closeOnEscape&&(d.keyCode&&d.keyCode===a.ui.keyCode.ESCAPE)&&(b.close(d),d.preventDefault())}).attr({role:"dialog","aria-labelledby":c}).mousedown(function(a){b.moveToTop(!1,a)});b.element.show().removeAttr("title").addClass("ui-dialog-content ui-widget-content").appendTo(h);var l=(b.uiDialogTitlebar=a("<div></div>")).addClass("ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix").prependTo(h),k=a('<a href="#"></a>').addClass("ui-dialog-titlebar-close ui-corner-all").attr("role",
"button").hover(function(){k.addClass("ui-state-hover")},function(){k.removeClass("ui-state-hover")}).focus(function(){k.addClass("ui-state-focus")}).blur(function(){k.removeClass("ui-state-focus")}).click(function(a){b.close(a);return!1}).appendTo(l);(b.uiDialogTitlebarCloseText=a("<span></span>")).addClass("ui-icon ui-icon-closethick").text(e.closeText).appendTo(k);a("<span></span>").addClass("ui-dialog-title").attr("id",c).html(d).prependTo(l);a.isFunction(e.beforeclose)&&!a.isFunction(e.beforeClose)&&
(e.beforeClose=e.beforeclose);l.find("*").add(l).disableSelection();e.draggable&&a.fn.draggable&&b._makeDraggable();e.resizable&&a.fn.resizable&&b._makeResizable();b._createButtons(e.buttons);b._isOpen=!1;a.fn.bgiframe&&h.bgiframe()},_init:function(){this.options.autoOpen&&this.open()},destroy:function(){this.overlay&&this.overlay.destroy();this.uiDialog.hide();this.element.unbind(".dialog").removeData("dialog").removeClass("ui-dialog-content ui-widget-content").hide().appendTo("body");this.uiDialog.remove();
...
!1;if(b.target===e[0]&&b.shiftKey)return f.focus(1),!1}});a(this.element.find(":tabbable").get().concat(e.find(".ui-dialog-buttonpane :tabbable").get().concat(e.get()))).eq(0).focus();this._isOpen=!0;this._trigger("open");return this}},_createButtons:function(b){var e=this,d=!1,c=a("<div></div>").addClass("ui-dialog-buttonpane ui-widget-content ui-helper-clearfix"),h=a("<div></div>").addClass("ui-dialog-buttonset").appendTo(c);e.uiDialog.find(".ui-dialog-buttonpane").remove();"object"===typeof b&&
null!==b&&a.each(b,function(){return!(d=!0)});d&&(a.each(b,function(b,f){f=a.isFunction(f)?{click:f,text:b}:f;b=a('<button type="button"></button>').attr(f,!0).unbind("click").click(function(){f.click.apply(e.element[0],arguments)}).appendTo(h);a.fn.button&&b.button()}),c.appendTo(e.uiDialog))},_makeDraggable:function(){function b(a){return{position:a.position,offset:a.offset}}var e=this,d=e.options,c=a(document),h;e.uiDialog.draggable({cancel:".ui-dialog-content, .ui-dialog-titlebar-close",handle:".ui-dialog-titlebar",
containment:"document",start:function(c,j){h="auto"===d.height?"auto":a(this).height();a(this).height(a(this).height()).addClass("ui-dialog-dragging");e._trigger("dragStart",c,b(j))},drag:function(a,d){e._trigger("drag",a,b(d))},stop:function(l,k){d.position=[k.position.left-c.scrollLeft(),k.position.top-c.scrollTop()];a(this).removeClass("ui-dialog-dragging").height(h);e._trigger("dragStop",l,b(k));a.ui.dialog.overlay.resize()}})},_makeResizable:function(f){function e(a){return{originalPosition:a.originalPosition,
originalSize:a.originalSize,position:a.position,size:a.size}}f=f===b?this.options.resizable:f;var d=this,c=d.options,h=d.uiDialog.css("position");f="string"===typeof f?f:"n,e,s,w,se,sw,ne,nw";d.uiDialog.resizable({cancel:".ui-dialog-content",containment:"document",alsoResize:d.element,maxWidth:c.maxWidth,maxHeight:c.maxHeight,minWidth:c.minWidth,minHeight:d._minHeight(),handles:f,start:function(b,f){a(this).addClass("ui-dialog-resizing");d._trigger("resizeStart",b,e(f))},resize:function(a,b){d._trigger("resize",
a,e(b))},stop:function(b,f){a(this).removeClass("ui-dialog-resizing");c.height=a(this).height();c.width=a(this).width();d._trigger("resizeStop",b,e(f));a.ui.dialog.overlay.resize()}}).css("position",h).find(".ui-resizable-se").addClass("ui-icon ui-icon-grip-diagonal-se")},_minHeight:function(){var a=this.options;return"auto"===a.height?a.minHeight:Math.min(a.minHeight,a.height)},_position:function(b){var e=[],d=[0,0],c;if(b){if("string"===typeof b||"object"===typeof b&&"0"in b)e=b.split?b.split(" "):
[b[0],b[1]],1===e.length&&(e[1]=e[0]),a.each(["left","top"],function(a,b){+e[a]===e[a]&&(d[a]=e[a],e[a]=b)}),b={my:e.join(" "),at:e.join(" "),offset:d.join(" ")};b=a.extend({},a.ui.dialog.prototype.options.position,b)}else b=a.ui.dialog.prototype.options.position;(c=this.uiDialog.is(":visible"))||this.uiDialog.show();this.uiDialog.css({top:0,left:0}).position(a.extend({of:window},b));c||this.uiDialog.hide()},_setOptions:function(b){var e=this,g={},j=!1;a.each(b,function(a,b){e._setOption(a,b);a in
c&&(j=!0);a in d&&(g[a]=b)});j&&this._size();this.uiDialog.is(":data(resizable)")&&this.uiDialog.resizable("option",g)},_setOption:function(b,e){var d=this.uiDialog;switch(b){case "beforeclose":b="beforeClose";break;case "buttons":this._createButtons(e);break;case "closeText":this.uiDialogTitlebarCloseText.text(""+e);break;case "dialogClass":d.removeClass(this.options.dialogClass).addClass("ui-dialog ui-widget ui-widget-content ui-corner-all "+e);break;case "disabled":e?d.addClass("ui-dialog-disabled"):
d.removeClass("ui-dialog-disabled");break;case "draggable":var c=d.is(":data(draggable)");c&&!e&&d.draggable("destroy");!c&&e&&this._makeDraggable();break;case "position":this._position(e);break;case "resizable":(c=d.is(":data(resizable)"))&&!e&&d.resizable("destroy");c&&"string"===typeof e&&d.resizable("option","handles",e);!c&&!1!==e&&this._makeResizable(e);break;case "title":a(".ui-dialog-title",this.uiDialogTitlebar).html(""+(e||"&#160;"))}a.Widget.prototype._setOption.apply(this,arguments)},
_size:function(){var b=this.options,e,d,c=this.uiDialog.is(":visible");this.element.show().css({width:"auto",minHeight:0,height:0});b.minWidth>b.width&&(b.width=b.minWidth);e=this.uiDialog.css({height:"auto",width:b.width}).height();d=Math.max(0,b.minHeight-e);"auto"===b.height?a.support.minHeight?this.element.css({minHeight:d,height:"auto"}):(this.uiDialog.show(),b=this.element.css("height","auto").height(),c||this.uiDialog.hide(),this.element.height(Math.max(b,d))):this.element.height(Math.max(b.height-
e,0));this.uiDialog.is(":data(resizable)")&&this.uiDialog.resizable("option","minHeight",this._minHeight())}});a.extend(a.ui.dialog,{version:"1.8.9",uuid:0,maxZ:0,getTitleId:function(a){a=a.attr("id");a||(a=this.uuid+=1);return"ui-dialog-title-"+a},overlay:function(b){this.$el=a.ui.dialog.overlay.create(b)}});a.extend(a.ui.dialog.overlay,{instances:[],oldInstances:[],maxZ:0,events:a.map("focus mousedown mouseup keydown keypress click".split(" "),function(a){return a+".dialog-overlay"}).join(" "),
...
a(this);b.html(b.data("label.tabs")).removeData("label.tabs")})},_tabify:function(b){function c(b,d){b.css({display:""});!a.support.opacity&&d.opacity&&b[0].style.removeAttribute("filter")}this.list=this.element.find("ol,ul").eq(0);this.lis=a("li:has(a[href])",this.list);this.anchors=this.lis.map(function(){return a("a",this)[0]});this.panels=a([]);var e=this,g=this.options,j=/^#.+/;this.anchors.each(function(b,d){var c=a(d).attr("href"),f=c.split("#")[0],h;if(f&&(f===location.toString().split("#")[0]||
(h=a("base")[0])&&f===h.href))c=d.hash,d.href=c;j.test(c)?e.panels=e.panels.add(e._sanitizeSelector(c)):"#"!=c?(a.data(d,"href.tabs",c),a.data(d,"load.tabs",c.replace(/#.*$/,"")),c=e._tabId(d),d.href="#"+c,d=a("#"+c),d.length||(d=a(g.panelTemplate).attr("id",c).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").insertAfter(e.panels[b-1]||e.list),d.data("destroy.tabs",!0)),e.panels=e.panels.add(d)):g.disabled.push(b)});b?(this.element.addClass("ui-tabs ui-widget ui-widget-content ui-corner-all"),
...
"removeClass"]("ui-tabs-collapsible");g.cookie&&this._cookie(g.selected,g.cookie);b=0;for(var h;h=this.lis[b];b++)a(h)[-1!=a.inArray(b,g.disabled)&&!a(h).hasClass("ui-tabs-selected")?"addClass":"removeClass"]("ui-state-disabled");!1===g.cache&&this.anchors.removeData("cache.tabs");this.lis.add(this.anchors).unbind(".tabs");if("mouseover"!=g.event){var l=function(a,b){b.is(":not(.ui-state-disabled)")&&b.addClass("ui-state-"+a)};this.lis.bind("mouseover.tabs",function(){l("hover",a(this))});this.lis.bind("mouseout.tabs",
function(){a(this).removeClass("ui-state-hover")});this.anchors.bind("focus.tabs",function(){l("focus",a(this).closest("li"))});this.anchors.bind("blur.tabs",function(){a(this).closest("li").removeClass("ui-state-focus")})}var k,q;g.fx&&(a.isArray(g.fx)?(k=g.fx[0],q=g.fx[1]):k=q=g.fx);var r=q?function(b,d){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");d.hide().removeClass("ui-tabs-hide").animate(q,q.duration||"normal",function(){c(d,q);e._trigger("show",null,e._ui(b,d[0]))})}:function(b,
d){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");d.removeClass("ui-tabs-hide");e._trigger("show",null,e._ui(b,d[0]))},s=k?function(a,b){b.animate(k,k.duration||"normal",function(){e.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");c(b,k);e.element.dequeue("tabs")})}:function(a,b){e.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");e.element.dequeue("tabs")};this.anchors.bind(g.event+".tabs",function(){var b=this,d=a(this).closest("li"),
c=e.panels.filter(":not(.ui-tabs-hide)"),f=a(e._sanitizeSelector(this.hash));if(d.hasClass("ui-tabs-selected")&&!g.collapsible||d.hasClass("ui-state-disabled")||d.hasClass("ui-state-processing")||!1===e._trigger("select",null,e._ui(this,f[0])))return this.blur(),!1;g.selected=e.anchors.index(this);e.abort();if(g.collapsible){if(d.hasClass("ui-tabs-selected"))return g.selected=-1,g.cookie&&e._cookie(g.selected,g.cookie),e.element.queue("tabs",function(){s(b,c)}).dequeue("tabs"),this.blur(),!1;if(!c.length)return g.cookie&&
e._cookie(g.selected,g.cookie),e.element.queue("tabs",function(){r(b,f)}),e.load(e.anchors.index(this)),this.blur(),!1}g.cookie&&e._cookie(g.selected,g.cookie);if(f.length)c.length&&e.element.queue("tabs",function(){s(b,c)}),e.element.queue("tabs",function(){r(b,f)}),e.load(e.anchors.index(this));else throw"jQuery UI Tabs: Mismatching fragment identifier.";a.browser.msie&&this.blur()});this.anchors.bind("click.tabs",function(){return!1})},destroy:function(){var b=this.options;this.abort();this.element.unbind(".tabs").removeClass("ui-tabs ui-widget ui-widget-content ui-corner-all ui-tabs-collapsible").removeData("tabs");
...
b.cookie&&this._cookie(null,b.cookie);return this},add:function(b,c,e){void 0===e&&(e=this.anchors.length);var g=this,j=this.options;c=a(j.tabTemplate.replace(/#\{href\}/g,b).replace(/#\{label\}/g,c));b=!b.indexOf("#")?b.replace("#",""):this._tabId(a("a",c)[0]);c.addClass("ui-state-default ui-corner-top").data("destroy.tabs",!0);var h=a("#"+b);h.length||(h=a(j.panelTemplate).attr("id",b).data("destroy.tabs",!0));h.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide");e>=this.lis.length?
(c.appendTo(this.list),h.appendTo(this.list[0].parentNode)):(c.insertBefore(this.lis[e]),h.insertBefore(this.panels[e]));j.disabled=a.map(j.disabled,function(a){return a>=e?++a:a});this._tabify();1==this.anchors.length&&(j.selected=0,c.addClass("ui-tabs-selected ui-state-active"),h.removeClass("ui-tabs-hide"),this.element.queue("tabs",function(){g._trigger("show",null,g._ui(g.anchors[0],g.panels[0]))}),this.load(0));this._trigger("add",null,this._ui(this.anchors[e],this.panels[e]));return this},remove:function(b){var c=
...
".tabs");return this},load:function(b){var c=this,e=this.options,g=this.anchors.eq(b)[0],j=a.data(g,"load.tabs");this.abort();if(!j||0!==this.element.queue("tabs").length&&a.data(g,"cache.tabs"))this.element.dequeue("tabs");else{this.lis.eq(b).addClass("ui-state-processing");if(e.spinner){var h=a("span",g);h.data("label.tabs",h.html()).html(e.spinner)}this.xhr=a.ajax(a.extend({},e.ajaxOptions,{url:j,success:function(h,j){a(c._sanitizeSelector(g.hash)).html(h);c._cleanup();e.cache&&a.data(g,"cache.tabs",
!0);c._trigger("load",null,c._ui(c.anchors[b],c.panels[b]));try{e.ajaxOptions.success(h,j)}catch(q){}},error:function(a,h){c._cleanup();c._trigger("load",null,c._ui(c.anchors[b],c.panels[b]));try{e.ajaxOptions.error(a,h,b,g)}catch(j){}}}));c.element.dequeue("tabs");return this}},abort:function(){this.element.queue([]);this.panels.stop(!1,!0);this.element.queue("tabs",this.element.queue("tabs").splice(-2,2));this.xhr&&(this.xhr.abort(),delete this.xhr);this._cleanup();return this},url:function(a,b){this.anchors.eq(a).removeData("cache.tabs").data("load.tabs",
b);return this},length:function(){return this.anchors.length}});a.extend(a.ui.tabs,{version:"1.8.2"});a.extend(a.ui.tabs.prototype,{rotation:null,rotate:function(a,b){var c=this,g=this.options,j=c._rotate||(c._rotate=function(b){clearTimeout(c.rotation);c.rotation=setTimeout(function(){var a=g.selected;c.select(++a<c.anchors.length?a:0)},a);b&&b.stopPropagation()});b=c._unrotate||(c._unrotate=!b?function(a){a.clientX&&c.rotate(null)}:function(){t=g.selected;j()});a?(this.element.bind("tabsshow",j),
this.anchors.bind(g.event+".tabs",b),j()):(clearTimeout(c.rotation),this.element.unbind("tabsshow",j),this.anchors.unbind(g.event+".tabs",b),delete this._rotate,delete this._unrotate);return this}})})(jQuery);(function(a){a.storage=new a.store;a.wa.errorHandler=function(b){a.storage.del("site/"+a.wa.site.domain+"/hash");return 404==b.status?(a.wa.setHash("#/"),!1):!0};a.wa.site={options:[],domain:0,helper:"",init:function(b){"undefined"!=typeof a.History&&a.History.bind(function(){a.wa.site.dispatch()});this.domain=b.domain;this.options=b;b=window.location.hash;"#/"===b||!b?(b=a.storage.get("site/"+this.domain+"/hash"))&&null!=b?a.wa.setHash("#/"+b):this.dispatch():a.wa.setHash(b)},setHelper:function(b){if(!0===
b)return!1;b?(this.helper=b,a("#s-save-panel div.s-dropdown").show()):(this.helper="",a("#s-save-panel div.s-dropdown").hide())},dispatch:function(b){void 0==b&&(b=window.location.hash);if(b=b.replace(/^[^#]*#\/*/,""))if(b=b.split("/"),b[0]){for(var c="",d=b.length,f=0;f<b.length;f++){var e=b[f];if(2>f)if(0===f)c=e;else if("files"==c){d=f;break}else if(parseInt(e,10)!=e&&-1==e.indexOf("="))c+=e.substr(0,1).toUpperCase()+e.substr(1);else{d=f;break}else{d=f;break}}d=b.slice(d);this[c+"Action"]?(this[c+
"Action"].apply(this,d),a.storage.set("site/"+this.domain+"/hash",b.join("/"))):console&&console.log("Invalid action name:",c+"Action")}else this.defaultAction();else this.defaultAction()},defaultAction:function(){var b=a("div.s-sidebar ul.s-links a:first").attr("href");a.wa.setHash(b)},pagesAction:function(b){a("#wa-page-container").length?waLoadPage(b):(a("#s-save-panel input").replaceWith('<input id="wa-page-button" type="button" class="button green" value="'+$_("Save")+'">'),a("#s-content").load("?module=pages",
"domain_id="+this.domain+(b?"&id="+b:""),function(){a(".s-scrollable-part").scrollTop(0);a.wa.site.savePanel(!0,"s-page-editor");a.wa.site.active(a("#s-link-pages"));a("#wa-page-button").click(function(){a("#wa-page-form").submit()})}))},newsiteAction:function(b){b=this.parseParams(b);a("#domain-name").val(b.domain||"");a("#addsite-dialog").waDialog({onSubmit:function(){var b=a(this);a.post(b.attr("action"),b.serialize(),function(a){"ok"==a.status&&(location.href="?domain_id="+a.data.id+"#/settings/")},
"json");return!1}});a("#s-content .triple-padded .loading").length&&this.defaultAction()},designAction:function(b){a("#wa-design-container").length?(waDesignLoad(void 0===b?"":b),a.wa.site.savePanel(!b||-1==b.indexOf("action=")),a("#wa-design-button").removeClass("yellow").addClass("green")):(this.parseParams(b),a("#s-save-panel input").replaceWith('<input id="wa-design-button" type="button" class="button green" value="'+$_("Save")+'">'),a("#s-content").load("?module=design","domain_id="+this.domain,
function(){a(".s-scrollable-part").scrollTop(0);a.wa.site.savePanel(!b||-1==b.indexOf("action="));a.wa.site.active(a("#s-link-design"));a("#wa-design-button").click(function(){a("#wa-design-form").submit()});waDesignLoad(void 0===b?"":b)}))},themesAction:function(){this.savePanel(!1);a("#wa-design-container").length?waDesignLoad():a("#s-content").load("?module=design","domain_id="+this.domain,function(){a(".s-scrollable-part").scrollTop(0);a.wa.site.active(a("#s-link-design"));waDesignLoad()})},designAddAction:function(a){this.designAction(a+
"&file=")},filesAction:function(b,c){this.savePanel(!1);if(!0===b)var d=c||this.filesPath();else d=Array.prototype.join.call(arguments,"/"),b=!1;var f=function(){a.wa.site.active(a("#s-link-files"));a("#s-files-tree li.selected").removeClass("selected");if(d){a("a.s-baseurl").removeClass("selected");a("#s-folder-actions-li").show();var b=a("#s-files-tree a[href='#/files/"+d+"']");b.parent().addClass("selected");for(b=b.parent();b.length;){var c=b.find("> i.overhanging");c.hasClass("rarr")&&c.click();
b=b.parent("ul").parent("li")}}else a("#s-folder-actions-li").hide(),a("a.s-baseurl").addClass("selected");a.wa.site.filesList(d);a("#s-upload-path").val(d||"");a("#s-current-path").html("/"+(d||""));a("#s-files-count").html("0");a("#s-files-grid input.all").removeAttr("checked")};a("#s-files-tree").length&&!b?f():a("#s-content").load("?module=files","domain_id="+this.domain,function(){a(".s-scrollable-part").scrollTop(0);a("#s-files-tree i.overhanging").click(function(){var b=a(this);b.hasClass("rarr")?
b.removeClass("rarr").addClass("darr").parent().children("ul").show():b.removeClass("darr").addClass("rarr").parent().children("ul").hide()});!0===b&&c?a.wa.setHash("#/files/"+c):f()})},filesList:function(b){b||(b=this.filesPath());a.post("?module=files&action=list",{path:b},function(b){a("#s-files-grid tr.s-file").remove();for(var d=0;d<b.data.length;d++){var f='<tr class="s-file"><td class="min-width"><input type="checkbox" value="'+b.data[d].file+'" /></td><td><ul class="menu-h dropdown clickable"><li><a href="#"><i class="icon16 '+
b.data[d].type+'"></i> '+b.data[d].file+' <i class="icon10 darr no-overhanging s-file-actions"></i></a></li></ul></td><td>'+b.data[d].datetime+'</td><td><span class="float-right">'+a.wa.site.getFileSize(b.data[d].size)+"</span></td></tr>";a("#s-files-grid").append(f)}},"json")},getFileSize:function(a){return 1024>a?a+" B":1048576>a?Math.round(a/1024)+" KB":1073741824>a?Math.round(a/1048576)+" MB":Math.round(a/1073741824)+" GB"},checkFileType:function(a){return"image"==a||"text"==a||"script-css"==
a||"script-js"==a},getFileMenu:function(b){var c=a("#s-domain").attr("href")+"wa-data/public/site/"+a.wa.site.filesPath()+b,d=a('<ul class="menu-v width-icons" style="display:block"></ul>');".php"!=b.substr(-4)&&(".phtml"!=b.substr(-6)&&"."!=b.substr(0,1))&&d.append('<li><i class="icon16 globe"></i>'+$_("File URL")+': <a href="'+c+'" target="_blank" class="bold">'+c+'<i class="icon10 new-window"></i></a></li>');".php"!=b.substr(-4)&&".phtml"!=b.substr(-6)&&d.append('<li><a href="?module=files&action=download&path='+
a.wa.site.filesPath()+"&file="+b+'"><i class="icon16 download"></i>'+$_("Download")+"</a></li>");d.append(a("<li></li>").append('<a href="#"><i class="icon16 edit"></i>'+$_("Rename")+"</a>").click(function(){a("#s-rename-dialog").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a("#s-name").val(b).focus().select();a(this).find("span").html(a.wa.site.filesPath(!0))},onSubmit:function(){var c=a("#s-name").val();a.post("?module=files&action=rename",{path:a.wa.site.filesPath(),name:c,file:b},function(b){"ok"==
b.status?(a.wa.site.filesList(),a("#s-rename-dialog").hide()):"fail"==b.status&&(alert(b.errors),a("#s-rename-dialog input[type=submit]").removeAttr("disabled"))},"json");return!1}});return!1}));d.append(a("<li></li>").append('<a href="#"><i class="icon16 move"></i>'+$_("Move to folder")+"</a>").click(function(){a("#s-move-dialog select").html(a.wa.site.filesPathOptions(a("#s-files-tree > ul.s-folderlist"),""));a("#s-move-dialog-files").html('<input type="hidden" name="file" value="'+b+'" />');a("#s-move-dialog input[name=path]").val(a.wa.site.filesPath());
a("#s-move-dialog h1 span").empty();a("#s-move-dialog").waDialog({disableButtonsOnSubmit:!0,onSubmit:function(){a.post("?module=files&action=move",a("#s-move-dialog form").serialize(),function(b){"ok"==b.status?(a("#s-move-dialog").hide(),a.wa.site.filesList()):"fail"==b.status&&(alert(b.errors),a("#s-move-dialog input[type=submit]").removeAttr("disabled"))},"json");return!1}});return!1}));d.append(a("<li></li>").append('<a href="#"><i class="icon16 delete"></i>'+$_("Delete")+"</a>").click(function(){a("#s-delete-dialog").waDialog({content:"<h1>"+
$_("Delete file")+"</h1><p>"+$_("File")+" <b>"+b+"</b> "+$_("will be deleted without the ability to recover.")+"</p>",disableButtonsOnSubmit:!0,onSubmit:function(){a.post("?module=files&action=delete",{path:a.wa.site.filesPath(),file:b},function(b){"ok"==b.status?(a.wa.site.filesList(),a("#s-delete-dialog").hide()):"fail"==b.status&&(alert(b.errors),a("#s-delete-dialog input[type=submit]").removeAttr("disabled"))},"json")}});return!1}));return d},settingsAction:function(){this.savePanel(!1);a("#s-content").load("?module=settings&domain_id="+
this.domain,function(){a.wa.site.active(a("#s-link-settings"))})},settingsRoutingAction:function(){this.settingsAction("routing")},blocksAction:function(b){a("#s-save-panel input").replaceWith('<input id="s-editor-save-button" type="button" class="button green" value="'+$_("Save")+'">');a("#s-content").load("?module=blocks",b,function(){a(".s-scrollable-part").scrollTop(0);waEditorCodeMirrorInit({id:"content",save_button:"s-editor-save-button"});a("#s-editor-save-button").click(function(){a("#site-form").submit()});
a.wa.site.savePanel(!0);a.wa.site.setHelper("app=");a.wa.site.active(a("#s-link-blocks"))})},blocksAddAction:function(){this.blocksAction("id=")},active:function(b){a(".sidebar a.selected").removeClass("selected");a("ul.s-links li.selected").removeClass("selected");b&&b.length&&b.addClass("selected")},routingAction:function(b){this.savePanel(!1);a("#s-content").load("?module=routing","domain_id="+this.domain,function(){a.wa.site.active(a("#s-link-routing"));a("tr#route-"+b+" .s-route-settings").click()})},
parseParams:function(a){if(!a)return{};a=a.split("&");var c={};for(i=0;i<a.length;i++){var d=a[i].split("=");c[d[0]]=1<d.length?d[1]:""}return c},initEditor:function(b,c){if(!a("#"+b).length)return!1;var d=a("#"+b).attr("data-type");this.savePanel(!0);var f=a("div.s-editor.s-white").height()-a("div.s-editor.s-white .s-grey-toolbar").height()-50;300>f&&(f=300);wa_editor=CodeMirror.fromTextArea(document.getElementById(b),{mode:d?"text/"+d:"text/html",tabMode:"indent",height:"dynamic",lineWrapping:!0,
onKeyEvent:function(a,b){var c=jQuery.Event(b);"keydown"==c.type?waEditorKeyCallback(!1,{save_button:"s-editor-save-button"})(b):(c.type="keypress")&&waEditorKeyCallback(!0,{save_button:"s-editor-save-button"})(b)}});a(".CodeMirror-scroll").css("min-height",f+"px");this.setHelper(c||!1)},savePanel:function(b,c){b?(a("#s-save-panel").show(),a("#wa div.s-scrollable-part").removeClass("s-no-editor"),a("#s-save-panel input").removeClass("yellow").addClass("green"),a("#wa-editor-status").empty(),c?a("#s-save-panel .s-bottom-fixed-bar-content-offset").addClass(c):
a("#s-save-panel .s-bottom-fixed-bar-content-offset").attr("class","s-bottom-fixed-bar-content-offset")):(a("#s-save-panel").hide(),a("#wa div.s-scrollable-part").addClass("s-no-editor"))},getTreeHTML:function(a,c,d){d=d||"";c="<ul"+(c?"":' style="display:none"')+' class="menu-v with-icons'+(c?" "+c:"")+'">';for(var f="",e=0;e<a.length;e++)f="string"==typeof a[e]?a[e]:a[e].id,c+="<li>","string"!=typeof a[e]&&(c+='<i class="icon16 rarr overhanging"></i>'),c+='<a href="#/files/'+d+f+'/"><i class="icon16 folder"></i><b>'+
f+"</b></a>","string"!=typeof a[e]&&(c+=this.getTreeHTML(a[e].childs,!1,d+f+"/")),c+="</li>";return c+"</ul>"},filesPath:function(b){b=b?"wa-data/public/site/":"";return a("#s-files-tree li.selected").length?b+a("#s-files-tree li.selected a").attr("href").substr(8):b},filesPathOptions:function(b,c,d){c=c||"";var f="";""==c&&(f='<option value="">wa-data/public/site</a>',c="&nbsp;&nbsp;&nbsp;");d=d||!1;b.children("li").each(function(){var b=d&&a(this).find("> ul > li.selected").length||!d&&a(this).hasClass("selected")?
!0:!1,g=a(this).children("a");f+="<option "+(b?'selected="selected"':"")+' value="'+g.attr("href").substr(8)+'">'+c+g.children("b").html()+"</option>";if(a(this).children("ul").length&&(!d||!a(this).hasClass("selected")))f+=a.wa.site.filesPathOptions(a(this).children("ul"),c+"&nbsp;&nbsp;&nbsp;",d)});return f}}})(jQuery);
